package com.example.jose.copiacard;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //datos de activity_details

        //localizamos la lista dendro de y le cargamos  el adaptador
        ListView lv = (ListView) findViewById(R.id.listView);
        //El adaptador es cargador dentro del MainActivity con las datos del dataModel
        //(Entra y va cargando uno x uno todos los array que hay dentro
